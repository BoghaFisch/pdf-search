...
public class SearchGUI extends JFrame {
    ...
    public static final String homeDir = "C:/Users/David/workspace/ir_lab1_1";
    ...
    private void index() {
		synchronized ( indexLock ) {
		    ...
		    if (PRINT_TIMES)
		    	System.out.println("Time taken to index: "+(System.currentTimeMillis()-startTime));
		    resultWindow.setText( "\n  Done!" );
		}
    };
    ...
    public static void main( String[] args ) {
		...
		// Instead of using args, set a fixed directory to read
		String [] ddir = {"-d", "davisWiki" };
		s.decodeArgs(ddir);
